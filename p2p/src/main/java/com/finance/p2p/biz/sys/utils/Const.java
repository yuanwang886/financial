...
public class Const {
	...
	public interface USERKey {
		...
		Integer LEVEL_1 = 1; // 1级超过10人 小于 20人
		Integer LEVEL_2 = 2; // 1级超过20人
		Integer LEVEL_3 = 3; // 1级超过50人, 团队超过200
		Integer LEVEL_1_U = 10;
		Integer LEVEL_2_U = 20;
		Integer LEVEL_3_U = 50;
		Integer LEVEL_3_T = 200;
	...
	public interface RateKey {
		...
		/** 预付款 */
		BigDecimal SUBSIST = new BigDecimal(0.1);

		/** 剩余款 */
		BigDecimal SURPLUS = new BigDecimal(0.9);

		/** 日利息 */
		Double DAY_RATE = 0.01;
