		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input class="form-control" id="userName" name="userName" value="${account.userName}"
							 readonly></input>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input class="form-control" id="bank" name="bank"  value="${account.bank}"
							readonly></input>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input class="form-control" id="bankDetail" name="bankDetail"  value="${account.bankDetail}"
							readonly></input>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input class="form-control" id="bankCard" name="bankCard"  value="${account.bankCard}"
							readonly></input>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input class="form-control" id="alipay" name="alipay"  value="${account.alipay}"
							readonly></input>
					</div>
				</div>
			</div>
