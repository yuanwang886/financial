...
public class LoginController {
	...
	public Object registerByAdmin(HttpSession session, Model model, String realname, String phone, String password, String invitePhone) {

		boolean flag = true;
		try {
			loginService.registerByAdmin(realname, phone, password, invitePhone);
		} catch (Exception e) {
			model.addAttribute("message", e.getMessage());
			flag = false;
		}
