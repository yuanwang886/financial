			...
			<div class="box box-warning">
				...
				<form id="feedback-form" name="feedback-form"
					...
					<div class="box-content text-center">
						...
						<button type="button" id="publishBtn" class="btn btn-success" data-target="#myModel" data-toggle="modal">发布公告</button>
					</div>
				...
				.DataTable(
						{
							...
							"sAjaxSource" : ctx + "/notice/list", //这是要请求json数据的url
			...
			"id" : id
				...
				function(data) {
					if (data.result == 1) {
						...
						var start = $("#feedback_table").dataTable()
								.fnSettings()._iDisplayStart;
						var total = $("#feedback_table").dataTable()
								.fnSettings().fnRecordsDisplay();

						if ((total - start) == 1) {
							if (start > 0) {
								$("#feedback_table").dataTable().fnPageChange(
										'previous', true);
							}
							else {
