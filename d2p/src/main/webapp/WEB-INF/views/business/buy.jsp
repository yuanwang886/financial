				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<div class="form-group">
							<label for="money">请输入金额</label><label class="text-danger">（金额为500-5000，且是500的整数倍）</label>
...
<script>
	$(function() {
		$('#publishBtn').click(function() {
			...
			else if (!isNumberBy500(money) || (parseFloat(money) > 5000)) {
				$.alert({
					title : '提示',
					content : "您的金额不符合要求~",
					animation : 'zoom',
