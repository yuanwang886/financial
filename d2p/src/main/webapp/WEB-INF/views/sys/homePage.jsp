...
<style>
.info-box {
	border: 1px solid rgba(200, 20, 20, 0.1);
}
						...
						<div class="row">
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="info-box" data-target="#myModel" data-toggle="modal" data-url="/business/buy/risk">
									<span class="info-box-icon bg-green"><i class="glyphicon glyphicon-download"></i></span>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="info-box" data-target="#myModel" data-toggle="modal" data-url="/business/sell/advice">
									<span class="info-box-icon bg-green"><i class="glyphicon glyphicon-upload"></i></span>
									<div class="info-box-content">
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="info-box" data-url="/business/buy/list/index">
									<span class="info-box-icon bg-green"><i class="glyphicon glyphicon-align-left"></i></span>
									<div class="info-box-content">
						...
						<div class="row">
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="info-box" data-url="/user/team/index">
									<span class="info-box-icon bg-aqua"><i class="glyphicon glyphicon-gift"></i></span>
									<div class="info-box-content">
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="info-box" data-url="/user/wallet/index">
									<span class="info-box-icon bg-aqua"><i class="glyphicon glyphicon-jpy"></i></span>
									<div class="info-box-content">
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="info-box" data-url="/user/income/index">
									<span class="info-box-icon bg-aqua"><i class="glyphicon glyphicon-bookmark"></i></span>
									<div class="info-box-content">
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="info-box" data-url="/feedback/add">
									<span class="info-box-icon bg-aqua"><i class="glyphicon glyphicon-send"></i></span>
									<div class="info-box-content">
						...
						<div class="row">
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="info-box" data-url="/doc/help/index">
									<span class="info-box-icon bg-red"><i class="glyphicon glyphicon-sunglasses"></i></span>
									<div class="info-box-content">
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="info-box" data-url="/doc/warn/index">
									<span class="info-box-icon bg-red"><i class="glyphicon glyphicon-alert"></i></span>
									<div class="info-box-content">
